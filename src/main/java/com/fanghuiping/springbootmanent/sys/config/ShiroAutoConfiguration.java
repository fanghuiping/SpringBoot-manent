...
import com.fanghuiping.springbootmanent.sys.controller.Realm.UserRealm;
...
//		filters.put("authc", new ShiroLoginFilter());
    ...
    public static String getShiroDialect() {
        return SHIRO_DIALECT;
    }

    public static String getShiroFilter() {
        return SHIRO_FILTER;
    }
